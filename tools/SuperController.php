<?php
    ...
    class SuperController
    {
        public static function callPage($nom_page)
        {
            ...
            {
                case "connexion" : 
                    include_once("pages/connexion/controller_connexion.php");
                ...
                case "inscription" :
                    include_once("pages/inscription/Controller_inscription.php");
                ...
                case "accueil" :
                    include_once("pages/accueil/Controller_accueil.php");
                ...
                case "contact" :
                    include_once("pages/contact/Controller_contact.php");
                    ...
                    case "profil" :
                        include_once("pages/modif/Controller_profil.php");
                ...
                case "admin" :
                    include_once("pages/admin/Controller_admin.php");
                ...
                case "panier":
                    include_once("pages/panier/Controller_panier.php");
                ...
                case "produit":
                    include_once("pages/produit/Controller_produit.php");
